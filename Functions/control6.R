...
find.mix.combi<- function(f=f,
  ...
  res <- run.ga(n.plants=k,
                ...
                p.rec=p.rec,
                fitness=f)
  colnames(COMBI)[which(res$best.model)]
}
